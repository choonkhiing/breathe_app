...
<p style="text-align: center;"><a href="http://breathe.geekycs.com/reset-password/{{ $token }}" style="padding: 10px 45px;background: #00acac;color: white;font-size: 16px;margin-top: 37px;display: block;    margin-bottom: -35px;">Reset your password</a></p>
