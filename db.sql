...
--
-- Host: localhost    Database: breathe_app
-- ------------------------------------------------------
...
CREATE TABLE `groupinvitations` (
  ...
  `invitee` int(10) unsigned NOT NULL,
  `group_id` int(10) unsigned NOT NULL,
  `status` int(11) NOT NULL DEFAULT '0',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `groupinvitations_inviter_foreign` (`inviter`),
  KEY `groupinvitations_invitee_foreign` (`invitee`),
  KEY `groupinvitations_group_id_foreign` (`group_id`),
  CONSTRAINT `groupinvitations_group_id_foreign` FOREIGN KEY (`group_id`) REFERENCES `groups` (`id`),
  CONSTRAINT `groupinvitations_invitee_foreign` FOREIGN KEY (`invitee`) REFERENCES `users` (`id`),
  CONSTRAINT `groupinvitations_inviter_foreign` FOREIGN KEY (`inviter`) REFERENCES `users` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `groupinvitations`
--

LOCK TABLES `groupinvitations` WRITE;
/*!40000 ALTER TABLE `groupinvitations` DISABLE KEYS */;
/*!40000 ALTER TABLE `groupinvitations` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `settings` (
  ...
  `reminder_time` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '00:00:00',
  `day_before_remind` int(11) NOT NULL DEFAULT '-1',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `tasks` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `tasks_collection_id_foreign` (`collection_id`),
  KEY `tasks_user_id_foreign` (`user_id`),
  CONSTRAINT `tasks_collection_id_foreign` FOREIGN KEY (`collection_id`) REFERENCES `collections` (`id`),
...
CREATE TABLE `users` (
  ...
  `profile_pic` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'img/uploads/profile/user.jpg',
